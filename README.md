...
The primary objective was to diagnose Vrinda Store's annual performance to identify optimization opportunities for the upcoming fiscal year. Specifically, the analysis aims to:

* Determine which customer demographics drive the highest share of wallet.
...
The interactive dashboard provides a holistic view of the retail operations through:

* **Dynamic Slicers:** Interactive filters for Month, Channel, and Category allowing stakeholders to drill down into specific micro-segments instantly.

* **KPI Snapshot:** High-level summaries tracking Total Revenue (**₹21.17M**), order fulfillment health, and volume counts.

* **Sales vs. Orders Trend:** A dual-axis line-and-bar chart illustrating seasonal fluctuations to guide supply chain planning.

* **Demographic Breakdown:** Visual demographic matrices mapping purchasing volume by Gender (Men vs. Women) and Age Group (Adults, Teenagers, Seniors).

* **Geographic Map Distribution:** Strategic ranking of top-revenue generating states in India.
...
* **Data-to-Strategy Translation:** Gained a deep understanding of how raw transactional points directly translate into operational directives (e.g., reallocating ad budgets from low-performing channels like Nalli/Others to Amazon).

* **Strategic Consumer Profiling:** Learned to construct data-driven consumer avatars to align product categories with target audiences.
...
* Handled the end-to-end analytics pipeline: from raw `.csv` extraction, data auditing, cleaning, and metric formulation to architectural dashboard design.
